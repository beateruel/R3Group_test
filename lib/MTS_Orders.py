...
class MTS_order(object):
    ...
    def initialization(self, supplier_material,products_material,reoder_quantity):
        ...
        self.reoder_quantiy = reoder_quantity #amount in kg, pieces, litres (if fixed) purchased in each order
        self.min_reorder_quantity = reoder_quantity  #minimum amount of material purchased in each order
        self.max_reorder_quantity = reoder_quantity  #maximum amount of matteial can be purchased in each order
    ...
    def purchase(self,products_material,df_monthly_demand, PBT_price, month,ordering_cost):
